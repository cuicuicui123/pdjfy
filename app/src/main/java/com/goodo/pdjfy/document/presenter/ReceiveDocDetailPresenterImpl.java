...
public class ReceiveDocDetailPresenterImpl implements DetailPresenter {
    private DetailView mDetailView;
    private HttpMethods mHttpMethods;
    private BaseActivity mActivity;
    private int mId;

    private String KEY = "getReceiveDocDetail";

    public ReceiveDocDetailPresenterImpl(DetailView detailView, BaseActivity activity, int id) {
    ...
    public void getDetail() {
        ...
        mHttpMethods.getReceiveDocDetail(mId, cacheSubscriber);
    }
