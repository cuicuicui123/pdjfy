...
public class ScheduleMainView extends View {
    ...
    private void drawAfternoon(Canvas canvas) {
        ...
        drawRowLine(mSurface.mGradientDrawable, canvas, mSurface.mCellWidth, mSurface.mWeekHeight + mSurface.mCellHeight * 4);
    ...
    private void drawMorning(Canvas canvas) {
        ...
        drawRowLine(mSurface.mGradientDrawable, canvas, mSurface.mCellWidth, mSurface.mWeekHeight + mSurface.mCellHeight * 2);
