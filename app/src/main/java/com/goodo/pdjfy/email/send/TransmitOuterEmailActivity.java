...
import com.goodo.pdjfy.email.presenter.TransmitOuterEmailPresenterImpl;
...
public class TransmitOuterEmailActivity extends BaseSendOuterEmailActivity {
    ...
    protected void handleArgument() {
        ...
        mPresenter = new TransmitOuterEmailPresenterImpl(this, this, mIsInBox);
        ...
        mSendOuterEmailBean.setEmailId(mEmailDetailBean.getOuterMail_ID());
