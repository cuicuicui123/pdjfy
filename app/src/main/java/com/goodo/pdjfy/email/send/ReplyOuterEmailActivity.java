...
import com.goodo.pdjfy.email.presenter.ReplyOuterEmailPresenterImpl;
...
public class ReplyOuterEmailActivity extends BaseSendOuterEmailActivity {
    ...
    protected void handleArgument() {
        ...
        mPresenter = new ReplyOuterEmailPresenterImpl(this, this);
        ...
        mReceiverEdt.setText(mEmailDetailBean.getFrom());
        mSendOuterEmailBean.setOuterMailAddrId(mEmailDetailBean.getOuterMailAddr_ID());
        mSendOuterEmailBean.setEmailId(mEmailDetailBean.getOuterReceive_ID());
