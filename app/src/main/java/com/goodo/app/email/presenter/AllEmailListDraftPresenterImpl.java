...
public class AllEmailListDraftPresenterImpl extends BaseEmailListPresenterImpl {
    public AllEmailListDraftPresenterImpl(EmailListView emailListView, BaseActivity activity) {
        super(emailListView, activity);
        KEY_LIST = "getAllEmailDraftList";
    }
    ...
    public void getEmailList(int page, int size) {
        ...
        mHttpMethods.getAllEmailDraftList(page, size, cacheSubscriber);
    }
}
