...
import com.goodo.app.email.list.EmailTrashActivity;
import com.goodo.app.email.list.AllEmailReceiveActivity;
import com.goodo.app.email.list.AllEmailSendActivity;
import com.goodo.app.email.list.EmailDraftActivity;
import com.goodo.app.email.list.InnerEmailReceiveActivity;
import com.goodo.app.email.list.InnerEmailSendActivity;
import com.goodo.app.email.list.OuterEmailReceiveActivity;
import com.goodo.app.email.list.OuterEmailSendActivity;
import com.goodo.app.email.model.EmailBean;
import com.goodo.app.email.presenter.EmailPresenter;
import com.goodo.app.email.presenter.EmailPresenterImpl;
import com.goodo.app.email.view.EmailView;
